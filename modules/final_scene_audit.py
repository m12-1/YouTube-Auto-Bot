...
قاعدة صارمة قبل أي تقييم لكل مشهد: إن كان نص المشهد يذكر كيانًا محددًا بالاسم
(كوكب، جرم سماوي، شخص، مكان، كائن...) وكانت اللقطة الفعلية في الفيديو تُظهر
كيانًا آخر مختلفًا فعليًا (مثال: النص يقول "Venus"/الزهرة لكن اللقطة تُظهر
كوكب الأرض بمحيطاته الزرقاء وقاراته المميزة)، فهذا خطأ فادح (Entity Mismatch)
ويجب إعطاء ذلك المشهد تحديدًا score <= 2 مهما بدا التطابق البصري العام
(كوكب/فضاء) مقبولاً. لا تتساهل هنا حتى لو كانت هذه أفضل لقطة متاحة ظاهريًا،
واذكر في "issue" اسم الكيان الخاطئ الذي ظهر بدل الكيان الصحيح المذكور بالنص.

شاهد الفيديو المرفق وقيّم كل مشهد على حدة من 10 من حيث مدى تطابقه مع النص المقابل له
(بعد تطبيق قاعدة تطابق الهوية أعلاه أولاً)، وجودة الانتقال، ومدى ملاءمته كفيديو "شورت" لليوتيوب.
