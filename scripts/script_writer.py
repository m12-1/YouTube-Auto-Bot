...
4. Are ordered from the most precise/on-topic phrase to the safest still-relevant fallback, so a downstream fallback stays on-topic even if the first one still returns nothing.
