...
GEMINI_KEY_IMAGE = os.environ.get("GEMINI_KEY_IMAGE")     # مفتاح جوكر احتياطي — يُستخدم تلقائياً لو فشل أي مفتاح Gemini آخر
GEMINI_KEY_FILTER = os.environ.get("GEMINI_KEY_FILTER")   # التحقق البصري من الوسائط
GEMINI_KEY_FILTER_2 = os.environ.get("GEMINI_KEY_FILTER_2")  # مفتاح ثانٍ إضافي (اختياري) لمضاعفة حصة التحقق البصري اليومية

# ---------------------------------------------------------------------------
# مفتاح Groq — طبقة تحليل بصري ثانية (احتياطية) بين Gemini و CLIP
# راجع scripts/groq_client.py و SECRETS.md لمزيد من التفاصيل
# ---------------------------------------------------------------------------
GROQ_API_KEY = os.environ.get("GROQ_API_KEY")

# ---------------------------------------------------------------------------
# Puter AI — طبقة تحليل بصري ثالثة (بعد Groq وقبل CLIP)
# راجع scripts/puter_client.py و SECRETS.md
# ---------------------------------------------------------------------------
