...
def _videos_from_provider(provider: str, keywords: list[str], target_count: int, is_short: bool = True) -> tuple[list[dict], float]:
...
def _try_videos_across_providers(keywords: list[str], target_count: int, providers: list[str], is_short: bool = True) -> list[dict]:
