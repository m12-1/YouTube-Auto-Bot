...
# نسبة تفضيل الفيديو مقابل الصورة لكل مشهد (0.7 = يحاول فيديو أولاً بـ 70%
# من المشاهد، والباقي صور — يعطي تنويع طبيعي بدل نمط ثابت متكرر يفضح الأتمتة)
VIDEO_PREFERENCE_RATIO = 0.7
