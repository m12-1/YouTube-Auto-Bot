...
def _clip_check(image_path: str, narration: str) -> dict:
...
def _fallback_cascade(file_path: str, narration: str, check_path, is_temp: bool,
                       skip_puter: bool = False, topic_context: str = "") -> dict:
...
def verify(file_path: str, narration: str, topic_context: str = "") -> dict:
    """
