...
class _VerifyJob:
    ...
    __slots__ = ("id", "file_path", "narration", "check_path", "is_temp", "topic_context", "event", "result")

    def __init__(self, file_path: str, narration: str, check_path, is_temp: bool, topic_context: str = ""):
        ...
        self.result = False  # افتراضي آمن: لو حصل خطأ غير متوقع تماماً ولم يُحسم المشهد فعلياً، يُرفض ولا يمر
...
def _fallback_cascade(file_path: str, narration: str, check_path, is_temp: bool,
                       skip_puter: bool = False, topic_context: str = "") -> bool:
            ...
            try:
                ...
                if active_model == "puter":
                    ...
                    return _fallback_cascade(file_path, narration, check_path, is_temp,
                                              skip_puter=True, topic_context=topic_context)
                active_model = "puter"
                stalls = 0
                continue
                ...
                if isinstance(e, (TypeError, AttributeError, NameError)):
                    ...
                    return _fallback_cascade(file_path, narration, check_path, is_temp,
                                              skip_puter=(active_model == "puter"), topic_context=topic_context)
...
def verify(file_path: str, narration: str, topic_context: str = "") -> bool:
    """
    ...
    job = _VerifyJob(file_path, narration, check_path, is_temp, topic_context)
