...
def verify_media_relevance(image_path: str, narration: str) -> bool:
    ...
    models_to_try = [
        (MODEL_TEXT_LIGHT_35, "filter"),        # gemini-3.5-flash-lite (أحدث وأسرع — أول محاولة)
    ...
    print(f"[GEMINI ERROR] فشل التحقق البصري باستخدام كل النماذج الخمسة المتاحة: {last_error}")
