    ...
    while True:
        ...
        for provider in providers:
            ...
            for item in media_list:
                ...
                if verify:
                    if media_relevance_checker.verify_media_file(temp_path, narration, topic_context):
        ...
        for provider in providers:
            ...
            for fb_item in fb_list:
                ...
                if not fb_downloaded:
                    continue
                if (not verify) or media_relevance_checker.verify_media_file(fb_path, narration, topic_context):
