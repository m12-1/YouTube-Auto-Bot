...
# قبول مشاهد بتقييم 7.5-8.9 كـ"ناجحة" رغم أنها دون الهدف. أي مشهد يبقى دون
# هذه العتبة بعد استنفاد كل محاولات إعادة البحث (MAX_SCENE_AUDIT_RETRIES)
# يُترك كما هو ويُفرض على الفيديو كاملاً حالة "مراجعة يدوية" قبل النشر
# (انظر manual_review_required في main.py).
